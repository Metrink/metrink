...
public
class ASTFunctionName extends com.metrink.grammar.BaseNode {
  public ASTFunctionName(int id) {
    super(id);
  }

  public ASTFunctionName(MetrinkParser p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=68f28cee2a34316ca8bcf7676bf7bbe1 (do not edit this line) */
